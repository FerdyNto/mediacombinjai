...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <h1 class="m-0">Form Edit Artikel</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="{{ route('dashboard.artikel.update', ['id' => $artikel->id]) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="judul-artikel" name="judul_artikel" class="form-control"
                        value="{{ $artikel->judul }}" onkeyup="createTextSlug()">
                    @error('judul_artikel')
                ...
                {{-- <div class="mb-3">
                    <input type="text" id="slug" name="slug" class="form-control" value="{{ $artikel->slug }}">
                </div> --}}

                <div class="mb-3">
                    <label for="body" class="form-label">Isi Artikel</label>
                    <textarea name="body" id="body">{{ $artikel->body }}</textarea>
                    @error('body')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
